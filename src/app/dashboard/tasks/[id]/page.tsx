...
export default function Task() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[300px] text-center">
            <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">タスクが見つかりません</h2>
            <p className="text-gray-500 dark:text-gray-400 mb-4">指定されたタスクは存在しないか、削除された可能性があります。</p>
            <Link href="/dashboard/tasks" className="text-teal-500 dark:text-teal-400 hover:underline font-medium">
                タスク一覧に戻る
            </Link>
        </div>
    );
